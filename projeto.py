...
class projeto(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.ieee802_11_sync_short_0 = ieee802_11.sync_short(0.5, 2, True, True)
        self.ieee802_11_sync_long_0 = ieee802_11.sync_long(240, True, True)
        self.ieee802_11_parse_mac_0 = ieee802_11.parse_mac(True, True)
        self.ieee802_11_frame_equalizer_0 = ieee802_11.frame_equalizer(ieee802_11.LS, 5.89e9, 10e6, True, True)
        self.ieee802_11_decode_mac_0 = ieee802_11.decode_mac(True, False)
        self.foo_wireshark_connector_0 = foo.wireshark_connector(127, False)
        self.fir_filter_xxx_0_0 = filter.fir_filter_fff(1, firdes.low_pass(1,20e6,10e6,1e6,window.WIN_HAMMING,6.76))
        self.fir_filter_xxx_0_0.declare_sample_delay(0)
        self.fir_filter_xxx_0 = filter.fir_filter_ccc(1, firdes.low_pass(1,20e6,10e6,1e6,window.WIN_HAMMING,6.76))
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/wagner/Downloads/Wifi_Project_Baseband_recordings/Sample2_20MHz_Channel6.bin', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/wagner/Desktop/MEEC/CDIG/CDIG-T02-G08/wifi.pcap', False)
